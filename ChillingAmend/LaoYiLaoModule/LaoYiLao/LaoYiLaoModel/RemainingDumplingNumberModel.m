...
//       _number = [NSString stringWithFormat:@"%@",resultListDic[@"num"]];
        _switchAndNumModel = [RemainingDumlingNumberSwitchModel switchAndNumberModelWithDic:(NSDictionary *)value];
    }
}
@end
